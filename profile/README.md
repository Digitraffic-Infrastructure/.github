...
| **[Connect](../Connect.md)**            | Tools and utilities for establishing connections using BI and SI interfaces.           |      `4.0.10` <!-- CONNECT_VERSION --> | `1.0.18` <!-- CCONNECT_VERSION --> |
...
```sh
dotnet add package Digitraffic.Connect --version 1.0.18
```
```sh
...
```xml
<ItemGroup>
  <PackageReference Include="Digitraffic.Connect" Version="1.0.18" />
</ItemGroup>
```
```xml
<ItemGroup>
