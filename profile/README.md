...
| **[Connect](../Connect.md)**            | Tools and utilities for establishing connections using BI and SI interfaces.           |      `4.0.4` <!-- CONNECT_VERSION --> | `1.0.14` <!-- CCONNECT_VERSION --> |
...
```sh
dotnet add package Digitraffic.Connect --version 1.0.14
```
```sh
...
```xml
<ItemGroup>
  <PackageReference Include="Digitraffic.Connect" Version="1.0.14" />
</ItemGroup>
```
```xml
<ItemGroup>
