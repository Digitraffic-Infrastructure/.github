...
|--------------------------------------------|---------------------------------------------------------------------------------|:------------------------:|:------------------------:|
| **[EtsiLibrary](../ETSILibrary.md)**      | A library for generating, encoding, and decoding V2X messages compliant with the ETSI standard. |      `2.47` <!-- ETSILIB_VERSION --> | `1.0.15` <!-- CETSILIB_VERSION --> |
...
```
```sh
dotnet add package Digitraffic.Link.ETSI.EtsiLibrary --version 1.0.15
```
...
```xml
<ItemGroup>
  <PackageReference Include="Digitraffic.Link.ETSI.EtsiLibrary" Version="1.0.15" />
</ItemGroup>
```
