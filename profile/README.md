...
| **[Connect](../Connect.md)**            | Tools and utilities for establishing connections using BI and SI interfaces.           |      `4.0.4` <!-- CONNECT_VERSION --> | `1.0.13` <!-- CCONNECT_VERSION --> |
...
```sh
dotnet add package Digitraffic.Connect --version 1.0.13
```
```sh
...
```xml
<ItemGroup>
  <PackageReference Include="Digitraffic.Connect" Version="1.0.13" />
</ItemGroup>
```
```xml
<ItemGroup>
